  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const fetchBalance = await axios.post(
        `${API_HOST}/tenant/${props.credentials.application_id}/get-user-achievement-logs?limit=10&offset=0&filter[transaction]=${props.transaction}&filter[userAchievement]=${props.userAchievement}`,
        {
          ...props.credentials,
        }
      );
