...
export interface AchievementsLogsFilter {
  transaction?: string;
...
const AchievementsLogs = (props: AchievementsLogsFilter) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const fetchBalance = await axios.post(
        `${API_HOST}/tenant/${props.credentials.application_id}/get-user-achievement-logs?limit=${limit}&offset=${offset}&filter[transaction]=${props.transaction}&filter[userAchievement]=${props.userAchievement}`,
        {
          ...props.credentials,
        }
      );
    ...
    fetchData();
  }, [props.transaction, props.userAchievement]);
                  ...
                  <div className="container">
                    ...
                    {rec?.identifier.replace(/[_]/gi, " ")}
                      ...
                      <p className="available-achievement-2col">
                        ...
                        <span>
                          : {rec?.progress !== null ? rec?.progress : 0}
                        </span>
                      </p>
                      <p className="available-achievement-2col">
...
`;
export default AchievementsLogs;
