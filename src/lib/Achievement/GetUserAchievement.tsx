...
export interface IGetUserAchievement {
  credentials?: any;
  achieverId?: string;
}

const GetUserAchievement = (props: IGetUserAchievement) => {
  ...
  const onSubmit = async (data: any) => {
    try {
      const response = await axios.post(
        `${props.credentials.API_HOST || API_HOST}/tenant/${props.credentials.application_id}/user-achievements/get-active/${props.achieverId}`,
        {
          data,
        }
      );
...
export default GetUserAchievement;
