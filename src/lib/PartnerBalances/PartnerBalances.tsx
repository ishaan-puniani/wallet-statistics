  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      const fetchBalance = await axios.post(
        `${props.credentials.host || API_HOST}/tenant/${props.credentials.application_id}/get-current-balances-for-transaction-types?filter[userId]=${props.userId}&filter[currency]=${props.currency}`,
        {
          ...props.credentials,
        }
      );
