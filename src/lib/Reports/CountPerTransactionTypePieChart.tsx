...
const CountPerTransactionTypePieChart = (
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      let chartData;
      const countPerTransactionType =
        transactionsCount?.countPerTransactionType &&
        Object.keys(transactionsCount?.countPerTransactionType);
      if (countPerTransactionType?.length) {
        chartData = countPerTransactionType?.map((type: any) => {
          return {
            name: type,
            value: transactionsCount?.countPerTransactionType?.[type],
          };
        });
      }
